...
const correction = {
  confirmation: 'In-game screenshots: GLBC mk.3; user-confirmed 9000 RP and 9000 SL for both vehicles',
  replaces: 'frc_mk2',
...
function correctCa27(vehicle) {
  ...
  assert.deepEqual(result.t, [145800, 221000]);
  return result;
}
...
function main() {
  ...
  console.log(JSON.stringify({vehicles: vehicleIds, rack: [9000, 9000], totals: [145800, 221000]}));
}
